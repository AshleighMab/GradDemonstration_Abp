...
using GradDemonstration.Services.PersonService;
using GradDemonstration.Users.Dto;
...
namespace GradDemonstration.Services
{
    ...
    public class PersonAppService : ApplicationService, IpersonAppService
    {
        ...
        [AbpAuthorize(PermissionNames.Pages_Person_Create)]
        ...
        [AbpAuthorize(PermissionNames.Pages_Person_Update)]
        [HttpPut]
        ...
        [AbpAuthorize(PermissionNames.Pages_Person_Delete)]
        [HttpDelete]
