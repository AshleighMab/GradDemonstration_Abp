...
{
    public abstract class GradDemonstrationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GradDemonstrationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GradDemonstrationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GradDemonstrationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GradDemonstrationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GradDemonstrationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GradDemonstrationDbContext, Task<T>> func)
        {
            T result;
